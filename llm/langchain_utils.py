...
def get_llm(provider: str = "azure"):
    ...
    #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 openapi key gpt-oss-20b
    if provider.lower() == "azure":
        ...
        try:
            model = ChatGoogleGenerativeAI(
                model=st.secrets["GEMINI_MODEL_NAME"],
        ...
        try:
            ...
            model = ChatOpenAI(
                ...
                model=st.secrets["OPENROUTER_MODEL_NAME"],
